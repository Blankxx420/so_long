...
/*   Updated: 2024/01/18 15:25:13 by brguicho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_draw(t_game **game, int x, int y)
{
	...
	if ((*game)->x_player && (*game)->y_player)
		mlx_put_image_to_window((*game)->mlx, (*game)->win, (*game)->img_ground,(*game)->x_player * pxl, (*game)->y_player * pxl);
	(*game)->x_player = x;
	(*game)->y_player = y; 
	mlx_put_image_to_window((*game)->mlx, (*game)->win, (*game)->img_player, x * pxl, y * pxl);
}
